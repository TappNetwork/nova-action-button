<template>
  <div class="flex border-b border-40 nova-button-wrapper">
    <div class="w-1/4 py-4"></div>
    <div class="w-3/4 py-4">
      <button class="btn btn-default btn-primary" @click="confirmActionModalOpened = true" :disabled="field.readonly">{{ field.name }}</button>
